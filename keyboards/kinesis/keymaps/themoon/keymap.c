               ...
               _KC_GRV, _KC_LBRC, ALT_SHIFT_COMM, _KC_RBRC,
                              ...
                              CMD_ESC, SHIFT_ENTER_MAC, CTRL_DEL,
                                                 // left palm key
			                                           PALM_L_MAC,
    // right side
  _KC_F9, _KC_F10, _KC_F11, _KC_F12, KC_MPLY, KC_MRWD, KC_MFFD, _, TD(REST_TD),
...
[_PALM_L_MAC] = LAYOUT(
         ...
         HYPR(KC_F10), HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B),
           ...
           LGUI(KC_Z), LGUI(LSFT(KC_Z)), _LIST_FORCE_CLOSE_APPS_MAC,
                                                         PALM_L_MAC,
         HYPR(KC_F9), HYPR(KC_F10), HYPR(KC_F11), HYPR(KC_F12), KC__MUTE, KC__VOLDOWN, KC__VOLUP, _, _,
                ...
                _KC_GRV, _KC_LBRC, CTRL_SHIFT_COMM, _KC_RBRC,
                           ...
                           CTRL_ESC, SHIFT_ENTER_PC, ALT_SHIFT_DEL,
                                                   // left palm key
			                                             PALM_L_PC,
    // right side
    _KC_F9, _KC_F10, _KC_F11, _KC_F12, KC_MPLY, KC_MPRV, KC_MNXT, KEYB_CONTROL, TD(REST_TD),
...
[_PALM_L_PC] = LAYOUT(
         ...
         C(A(KC_F10)), C(A(KC_Z)), C(A(KC_X)), C(A(KC_C)), C(A(KC_V)), C(A(KC_B)),
             ...
             C(KC_Z), C(S(KC_Z)), _LIST_FORCE_CLOSE_APPS_PC,
                                             PALM_L_PC,
         C(A(KC_F9)), C(A(KC_F10)), C(A(KC_F11)), C(A(KC_F12)), KC_MUTE, KC_VOLD, KC_VOLU, _, _,
