...
[_PALM_L_MAC] = LAYOUT(
         ...
         HYPR(KC_F10), HYPR(KC_Z), S_F3_, KC_PGUP, F3_, HYPR(KC_B),
                        HYPR(KC_GRV), KC_HOME, KC_PGDN, KC_END,
                                HYPR(KC_BSPC), KC_MRWD,
                                               KC_MPLY,
         ...
         HYPR(KC_N), KC_BTN3, KC_MS_U, KC_BTN2, HYPR(KC_QUOT), HYPR(KC_F14),
                        KC_MS_L, KC_MS_D, KC_MS_R, HYPR(KC_NUBS),
         HYPR(KC_F16), HYPR(KC_BSPC),
         HYPR(KC_MINS),
         HYPR(KC_EQL), KC_WH_L, KC_BTN1,
         KC_WH_R
    ),
...
[_PALM_L_PC] = LAYOUT(
         ...
         C(A(KC_F20)), C(A(KC_Z)), S_F3_, KC_PGUP, F3_, C(A(KC_B)),
                C(A(KC_GRV)), C(KC_HOME), KC_PGDN, C(KC_END),
                               C(A(KC_BSPC)), KC_MPRV,
                                              KC_MPLY,
         ...
         C(A(KC_N)), KC_BTN3, KC_MS_U, KC_BTN2, C(A(KC_QUOT)), C(A(KC_F24)),
                     KC_MS_L, KC_MS_D, KC_MS_R, C(A(KC_NUBS)),
         C(A(KC_F16)), C(A(KC_BSPC)),
         C(A(KC_MINS)),
         C(A(KC_EQL)), KC_WH_L, KC_BTN1,
         KC_WH_R
    ),
