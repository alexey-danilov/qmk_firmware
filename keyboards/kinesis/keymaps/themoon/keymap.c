...
[_PALM_1_MAC] = LAYOUT(
         ...
         HYPR(KC_F12), HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B),
                 HYPR(KC_GRV), HYPR(KC_LBRC), HYPR(KC_F4), HYPR(KC_RBRC),
...
[_PALM_1_WIN] = LAYOUT(
         ...
         HYPR(KC_F20), HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B),
                 HYPR(KC_GRV), HYPR(KC_LBRC), HYPR(KC_COMM), HYPR(KC_RBRC),
                             HYPR(KC_BSPC), HYPR(KC_F24),
                                           HYPR(KC_SLSH),
    ...
    switch (keycode) {
       ...
       case PALM_1_WIN: {
        ...
        case PALM_2_WIN: {
          ...
          momentary_layer_tap(KC_F14, KC_NO, KC_LALT, KC_LCTL, KC_NO, KC_NO, &palm_2_win_layer_timer, &palm_2_win_interrupted, pressed, 300, false);
          return true;
        }
