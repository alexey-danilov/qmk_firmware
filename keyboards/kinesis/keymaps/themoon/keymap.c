...
#define _RWIN 21
#define _PALM_L_WIN 22
#define _PALM_R_WIN 23
...
enum kinesis_keycodes {
  ...
  ALT_BSLASH_AND_WIN = MO(_ALT_BSLASH_WIN),
...
enum holding_keycodes {
  ...
  // LWin + key overrides
  W_F1, W_F2, W_F3, W_F4, W_F5, W_F6, W_F7, W_F8, W_F9, W_F10, W_F11, W_F12,
...
bool lead_custom_autoshifted_with_mod(uint16_t code, uint16_t mod, uint16_t lead_code, uint16_t held_code, uint16_t held_mod, bool pressed, uint16_t hold_duration) {
  ...
  return lead_replace_if_held_add_mods(code, mod, held_code, held_mod, KC_NO, &was_lead, pressed, hold_duration);
}
  ...
  rest_tap_state.state = cur_dance(state);
    switch (rest_tap_state.state) {
      case SINGLE_TAP:
          ...
          if (isWin) {
            with_1_mod(KC_X, KC_LGUI); all_leds_on(); _delay_ms(125); all_leds_off(); key_code(KC_U); _delay_ms(200); all_leds_on(); _delay_ms(125); all_leds_off(); key_code(KC_S); break;
          }
      case DOUBLE_TAP:
         // shutdown
         all_leds_on();
         ...
         if (isWin) {
            with_1_mod(KC_X, KC_LGUI); _delay_ms(700); led_blue_off(); key_code(KC_U); _delay_ms(700); led_green_off(); _delay_ms(700); led_yellow_off(); _delay_ms(700); led_red_off(); _delay_ms(700); key_code(KC_U); _delay_ms(700); break;
         }
      default: break;
    }
}
...
[_MAC] = LAYOUT(
           ...
           KC_F17, _1_AT, _2_PLEFT, _3_SLASH, _4_PRGHT, _5_HASH,
  ...
  KC_F9, KC_F10, KC_F11, KC_F12, KC__MUTE, KC__VOLDOWN, KC__VOLUP, KEYB_CONTROL, TD(REST_TD),
	_6_DOL, _7_BANG, _8_DASH, _9_QUEST, _0_PERC, KC_F21,
	...
	KC_LEFT, KC_DOWN, KC_RGHT, KC_F16,
           ...
           _UP_ASTR, _EQL,
           ALT_BSLASH_AND_MAC,
           CTRL_F1_PIPE, SHIFT_TAB_MAC, CMD_SPACE,
           // right palm key
           PALM_R_MAC
    ),
...
[_COMMAND_ESCAPE] = LAYOUT(
         ...
         _MINS, _EQL,
         _BSLS,
         _NUBS, LANG_CAPS_MAC, LEAD_SPACE,
         KC_F15
    ),
...
[_WIN] = LAYOUT(
    ...
    KC_F9, KC_F10, KC_F11, KC_F12, KC_MUTE, KC_VOLD, KC_VOLU, KEYB_CONTROL, TD(REST_TD),
  	...
  	KC_LEFT, KC_DOWN, KC_RGHT, KC_F16,
           ...
           _UP_ASTR, _EQL,
           ALT_BSLASH_AND_WIN,
           RWIN_PIPE, SHIFT_TAB_WIN, CTRL_SPACE,
           // right palm key
           PALM_R_WIN
    ),
...
[_RWIN] = LAYOUT(
         LGUI(KC_GRV), LGUI(KC_F1), LGUI(KC_F2), LGUI(KC_F3), LGUI(KC_F4), LGUI(KC_F5), LGUI(KC_F6), LGUI(KC_F7), LGUI(KC_F8),
         ...
         LGUI(KC_F20), LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), LGUI(KC_V), LGUI(KC_B),
                LGUI(KC_F13), LGUI(KC_LBRC), LGUI(KC_COMM), LGUI(KC_RBRC),
                            ...
                            LGUI(KC_ESC), LGUI(KC_ENTER), LGUI(KC_DEL),
                                          LGUI(KC_F14),
    LGUI(KC_F9), LGUI(KC_F10), LGUI(KC_F11), LGUI(KC_F12), LGUI(KC_MUTE), LGUI(KC_VOLD), LGUI(KC_VOLU), KEYB_CONTROL, _,
  	...
  	LGUI(KC_LEFT), LGUI(KC_DOWN), LGUI(KC_RGHT), LGUI(KC_F16),
         ...
         LGUI(KC_BSLS),
         RWIN_PIPE, LGUI(KC_LSFT), LGUI(KC_LCTL),
         LGUI(KC_F16)
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (keycode != ALT_BSLASH_AND_MAC) { alt_bslash_mac_interrupted = true; }
    ...
    if (keycode != CTRL_F1_PIPE) { ctrl_f1_interrupted = true; }
    ...
    if (keycode != ALT_BSLASH_AND_WIN) { alt_bslash_win_interrupted = true; }
    ...
    if (keycode != RWIN_PIPE) { rwin_interrupted = true; }
    ...
    switch (keycode) {
        ...
        case _1_AT: { return lead_autoshifted_modified_numbers(KC_1, KC_2, KC_LSFT, pressed); }
        ...
        case _5_HASH: { return lead_autoshifted_modified_numbers(KC_5, KC_3, KC_LSFT, pressed); }
        case _6_DOL: { return lead_autoshifted_modified_numbers(KC_6, KC_4, KC_LSFT, pressed); }
        ...
        case _0_PERC: { return lead_autoshifted_modified_numbers(KC_0, KC_5, KC_LSFT, pressed); }

        case _UP_ASTR: { return lead_custom_autoshifted_with_mod(KC_6, KC_LSFT, KC_MINS, KC_8, KC_LSFT, pressed, AUTOSHIFT_SPECIAL_TERM); }
        case _EQL: { return lead_custom_autoshifted_with_mod(KC_EQL, KC_NO, KC_EQL, KC_EQL, KC_LSFT, pressed, AUTOSHIFT_SPECIAL_TERM); }
        ...
        case CTRL_F1_PIPE: {
          ...
          momentary_layer_tap_with_hold(KC_F1, KC_LCTL, KC_LCTL, KC_NO, KC_NO, KC_NO, &ctrl_f1_layer_timer, &ctrl_f1_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, true, KC_BSLS, KC_LSFT);
          return true;
        }
        ...
        case ALT_BSLASH_AND_MAC: {
          if (is_after_lead(KC_BSLS, pressed)) { return false; }
          static uint16_t alt_bslash_mac_layer_timer;
          momentary_layer_tap_with_hold(KC_BSLS, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, &alt_bslash_mac_layer_timer, &alt_bslash_mac_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, true, KC_7, KC_LSFT);
          return true;
        }
        ...
        case SHIFT_TAB_MAC: {
          ...
          momentary_layer_tap_with_hold(KC_TAB, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, &shift_tab_mac_layer_timer, &shift_tab_mac_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, true, KC_TAB, KC_LSFT);
          return true;
        }
        ...
        case PALM_L_MAC: {
          ...
          momentary_layer_tap(KC_F14, KC_NO, KC_LCTL, KC_LALT, KC_LSFT, KC_LGUI, &palm_l_mac_layer_timer, &palm_l_mac_interrupted, pressed, 500, true);
          return true;
        }
        ...
        case PALM_R_MAC: {
          ...
          momentary_layer_tap_with_hold(KC_F15, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, &palm_r_mac_layer_timer, &palm_r_mac_interrupted, pressed, 200, true, KC_F15, KC_LSFT);
          return true;
        }
        ...
        case RWIN_PIPE: {
          if (is_after_lead(KC_APP, pressed)) { return false; }
          static uint16_t rwin_layer_timer;
          momentary_layer_tap_with_hold(KC_RWIN, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, &rwin_layer_timer, &rwin_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, false, KC_BSLS, KC_LSFT);
          return true;
        }

        case ALT_BSLASH_AND_WIN: {
          if (is_after_lead(KC_BSLS, pressed)) { return false; }
          static uint16_t alt_bslash_win_layer_timer;
          momentary_layer_tap_with_hold(KC_BSLS, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, &alt_bslash_win_layer_timer, &alt_bslash_win_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, false, KC_7, KC_LSFT);
          return true;
        }
        ...
        case SHIFT_TAB_WIN: {
          ...
          momentary_layer_tap_with_hold(KC_TAB, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, &shift_tab_win_layer_timer, &shift_tab_win_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, true, KC_TAB, KC_LSFT);
          return true;
        }
        ...
        case PALM_L_WIN: {
          ...
          momentary_layer_tap(KC_F14, KC_NO, KC_LCTL, KC_LALT, KC_LSFT, KC_LGUI, &palm_l_win_layer_timer, &palm_l_win_interrupted, pressed, 500, false);
          return true;
        }
        ...
        case PALM_R_WIN: {
          ...
          momentary_layer_tap_with_hold(KC_F15, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, &palm_r_win_layer_timer, &palm_r_win_interrupted, pressed, 200, false, KC_F15, KC_LSFT);
          return true;
        }
        ...
        case _NUBS: { return if_held_autoshift(KC_NUBS, pressed); }
        case _APP: { return if_held_autoshift(KC_APP, pressed); }
        ...
        // app switch
        case CMD_TAB: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_TAB, KC_LALT, KC_LCTL, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, KC_LGUI, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, true); }
        case CMD_SHIFT_TAB: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_TAB, KC_LALT, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, KC_LGUI, KC_LSFT, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, true); }
        case ALT_TAB: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_TAB, KC_LGUI, KC_LCTL, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, KC_LALT, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, true); }
        case ALT_SHIFT_TAB: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_TAB, KC_LGUI, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, KC_LALT, KC_LSFT, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, true); }
        ...
        case CTRL_HOME: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_HOME, KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_HOME, KC_LCTL, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, false); }
        case CTRL_END: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_END, KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_END, KC_LCTL, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, false); }
        ...
        // f3 / shift + f3
        case FIND_NEXT: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_F3, KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_F3, KC_NO, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, false); }
        case FIND_PREV: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_F3, KC_LALT, KC_LSFT, KC_LCTL, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_F3, KC_LSFT, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, false); }

        // close app
        case CMD_Q: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_Q, KC_LALT, KC_LSFT, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_Q, KC_LGUI, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, true); }
        case ALT_F4: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_F4, KC_LGUI, KC_LSFT, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_F4, KC_F4, KC_LALT, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_QWERTY_KEYS_TERM, true); }
        ...
        case W_BSLS: { return replace_ctrl_alt_with_lgui(KC_BSLS, pressed); }
