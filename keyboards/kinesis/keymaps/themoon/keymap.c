...
[_PALM_R_MAC] = LAYOUT(
         KC__MUTE, HYPR(KC_F1), HYPR(KC_F2), HYPR(KC_F3), KC_MRWD, KC_MPLY, KC_MFFD, HYPR(KC_F7), HYPR(KC_F8),
         HYPR(KC_F7), HYPR(KC_1), HYPR(KC_2), HYPR(KC_3), HYPR(KC_4), HYPR(KC_5),
         HYPR(KC_F8), HYPR(KC_Q), HYPR(KC_W), HYPR(KC_E), HYPR(KC_R), HYPR(KC_T),
         HYPR(KC_F9), HYPR(KC_A), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), HYPR(KC_G),
         HYPR(KC_F10), HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B),
...
[_PALM_L_PC] = LAYOUT(
         C(A(KC_INS)), C(A(KC_F1)), C(A(KC_F2)), C(A(KC_F3)), KC_MPRV, KC_MPLY, KC_MNXT, C(A(KC_F7)), C(A(KC_F8)),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (keycode != SHIFT_TAB_MAC && keycode != SHIFT_TAB_PC && keycode != CMD_SPACE && keycode != CTRL_SPACE && keycode != KC_LEFT && keycode != KC_RGHT /* && keycode != _KC_K */) {
        esc_timer = 0;
    }
    ...
    switch (keycode) {
        ...
        case CTRL_F1: {
          ...
          momentary_layer_tap(KC_F1, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, &ctrl_f1_layer_timer, &ctrl_f1_interrupted, pressed, 300, true);
          return true;
        }
        ...
        case ALT_BSLS_MAC: {
          ...
          momentary_layer_tap_with_hold(KC_BSLS, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, &alt_bsls_mac_layer_timer, &alt_bsls_mac_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 300, false, KC_EQL, KC_LSFT, KC_NO);
          return true;
        }
        ...
        case RGUI: {
          ...
          momentary_layer_tap(KC_RGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, &rgui_layer_timer, &rgui_interrupted, pressed, 300, false);
          return true;
        }
