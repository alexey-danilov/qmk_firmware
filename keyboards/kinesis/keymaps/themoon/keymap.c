...
//**************** D Lang *********************//
static tap d_lang_tap_state = { .is_press_action = true, .state = 0 };

void d_lang_finished (qk_tap_dance_state_t *state, void *user_data) {
  d_lang_tap_state.state = cur_dance(state);
  if (!is_after_lead(KC_D, true)) {
    switch (d_lang_tap_state.state) {

      case SINGLE_HOLD:
          if (isMac) {
            with_1_mod(KC_SPC, KC_LALT);
            if (capsOnHardCheck()) { up(KC_LCAP); caps_led = false; led_blue_off(); } // on mac changing language resets caps lock
          } else {
      ...
      case DOUBLE_TAP:
          key_code(KC_D); key_code(KC_D); break;

      case DOUBLE_HOLD:
          key_code(KC_D); key_code(KC_D); break;

      default: key_code(KC_D); break;
    }
  }
}

void d_lang_reset (qk_tap_dance_state_t *state, void *user_data) {
  d_lang_tap_state.state = 0;
}

//**************** K Caps *********************//
static tap k_caps_tap_state = { .is_press_action = true, .state = 0 };

void k_caps_finished (qk_tap_dance_state_t *state, void *user_data) {
  k_caps_tap_state.state = cur_dance(state);
  if (!is_after_lead(KC_D, true)) {
    switch (k_caps_tap_state.state) {

      case SINGLE_HOLD:
          toggleCaps(); break;

      case DOUBLE_TAP:
          key_code(KC_K); key_code(KC_K); break;

      case DOUBLE_HOLD:
          key_code(KC_K); key_code(KC_K); break;

      default: key_code(KC_K); break;
    }
  }
}

void k_caps_reset (qk_tap_dance_state_t *state, void *user_data) {
  k_caps_tap_state.state = 0;
}
...
[_MAC] = LAYOUT(
           ...
           ALT_F9,KC_A, KC_S, TD(D_LANG), KC_F, KC_G,
  ...
  KC_F9, KC_F10, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KEYB_CONTROL, TD(REST_TD),
	...
	KC_H, KC_J, TD(K_CAPS), KC_L, KC_SCLN, ALT_F13,
...
[_COMMAND_ESCAPE] = LAYOUT(
         ...
         __________, __________, __________, KC_D, __________, __________,
         __________, __________, __________, __________, __________, __________,
...
[_PALM_L_MAC] = LAYOUT(
         ...
         HYPR(KC_Y), HYPR_U, HYPR_I, HYPR_O, HYPR(KC_P), HYPR(KC_F12),
...
[_PALM_R_MAC] = LAYOUT(
         ...
         __________, __________, __________, __________, __________, __________, __________, __________, __________,
         KC_6, KC_7, KC_8, KC_9, KC_0, __________,
         __________, HYPR_U, HYPR_I, HYPR_O, __________, __________,
         __________, HYPR_J, HYPR_K, HYPR_K, __________, __________,
         __________, HYPR_M, KC_PGUP, HYPR_SPC, __________, __________,
...
[_PC] = LAYOUT(
           ...
           KC_F19, KC_A, KC_S, TD(D_LANG), KC_F, KC_G,
    ...
    KC_F9, KC_F10, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KEYB_CONTROL, TD(REST_TD),
  	...
  	KC_H, KC_J, TD(K_CAPS), KC_L, KC_SCLN, KC_F23,
...
[_PALM_L_PC] = LAYOUT(
         ...
         C(A(KC_Y)), CA_U, CA_I, CA_O, C(A(KC_P)), C(A(KC_F22)),
         C(A(KC_H)), CA_J, CA_K, CA_K, C(A(KC_SCLN)), C(A(KC_F23)),
...
[_PALM_R_PC] = LAYOUT(
         ...
         __________, __________, __________, __________, __________, __________, __________, __________, __________,
         KC_6, KC_7, KC_8, KC_9, KC_0, __________,
         __________, CA_U, CA_I, CA_O, __________, __________,
         __________, CA_J, CA_K, CA_K, __________, __________,
         __________, CA_M, KC_PGUP, CA_DOT, __________, __________,
                   KC_HOME, KC_PGDN, KC_END, __________,
         _, _,
         _,
         _, _, _,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        ...
        case HYPR_U: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_U, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_LALT, KC_LCTL, KC_U, KC_LALT, KC_LCTL, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true ); }
        case HYPR_I: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_I, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_LALT, KC_LCTL, KC_I, KC_LALT, KC_LCTL, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true ); }
        case HYPR_O: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_O, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_LALT, KC_LCTL, KC_O, KC_LALT, KC_LCTL, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true ); }
        ...
        case HYPR_M: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_M, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_LALT, KC_LCTL, KC_M, KC_LALT, KC_LCTL, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true ); }
        case HYPR_SPC: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_SPC, KC_LGUI, KC_LSFT, KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_LALT, KC_LCTL, KC_SPC, KC_LALT, KC_LCTL, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true ); }

        case CA_U: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_U, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_U, KC_LSFT, KC_LALT, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, false ); }
        case CA_I: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_I, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_I, KC_LSFT, KC_LALT, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, false ); }
        case CA_O: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_O, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_O, KC_LSFT, KC_LALT, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, false ); }
        ...
        case CA_M: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_M, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_M, KC_LSFT, KC_LALT, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, false ); }
        case CA_DOT: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_DOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_LALT, KC_NO, KC_NO, KC_DOT, KC_LSFT, KC_LALT, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, false ); }
        ...
        case KC_LEFT: {
          ...
          return not_following_esc(isMac ? KC_LEFT :  KC_HOME, isMac ? KC_LGUI : KC_NO, KC_NO, KC_NO, &esc_timer, pressed, 300);
        }
        case KC_RGHT: {
          if (pressed) { right_pressed = true; } else { right_pressed = false; }
          if (is_after_lead(KC_RGHT, pressed)) { return false; }
          return not_following_esc(isMac ? KC_RGHT : KC_HOME, isMac ? KC_LGUI : KC_NO, KC_NO, KC_NO, &esc_timer, pressed, 300);
        }
        ...
        case CTRL_F1: {
          ...
          momentary_layer_tap_with_hold(KC_F1, KC_LCTL, KC_LCTL, KC_NO, KC_NO, KC_NO, &ctrl_f1_layer_timer, &ctrl_f1_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 400, false, KC_F17, KC_LCTL, KC_NO);
          return true;
        }
        ...
        case ALT_BSLS_MAC: {
          ...
          momentary_layer_tap_with_hold(KC_BSLS, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, &alt_bsls_mac_layer_timer, &alt_bsls_mac_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 400, false, KC_EQL, KC_LSFT, KC_NO);
          return true;
        }
        ...
        case SHIFT_TAB_MAC: {
          ...
          momentary_layer_tap_with_hold(KC_TAB, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, &shift_tab_mac_layer_timer, &shift_tab_mac_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 400, false, KC_EQL, KC_NO, KC_NO);
          return true;
        }
        ...
        case RGUI: {
          ...
          momentary_layer_tap_with_hold(KC_LGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, &rgui_layer_timer, &rgui_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 400, false, KC_DEL, KC_LCTL, KC_LALT);
          return true;
        }
        ...
        case ALT_BSLS_PC: {
          ...
          momentary_layer_tap_with_hold(KC_BSLS, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, &alt_bsls_pc_layer_timer, &alt_bsls_pc_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 400, false, KC_EQL, KC_LSFT, KC_NO);
          return true;
        }
        ...
        case SHIFT_TAB_PC: {
          ...
          momentary_layer_tap_with_hold(KC_TAB, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, &shift_tab_pc_layer_timer, &shift_tab_pc_interrupted, pressed, AUTOSHIFT_SPECIAL_TERM, 400, false, KC_EQL, KC_NO, KC_NO);
          return true;
        }
        ...
        case SELECT_LEFT_MAC: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_LEFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_LSFT, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true); }
        case SELECT_RIGHT_MAC: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_RGHT, KC_NO, KC_NO, KC_NO, KC_NO, KC_LALT, KC_NO, KC_NO, KC_NO, KC_RGHT, KC_LSFT, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true); }
        ...
        case SELECT_LEFT_PC: { return replace_key_and_mods_if_held_replace_key_and_mods(KC_LEFT, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_HOME, KC_LSFT, KC_NO, KC_NO, KC_NO, pressed, AUTOSHIFT_SPECIAL_TERM, true); }
